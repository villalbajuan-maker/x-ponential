...
- Las secciones previstas en negocio, producto, piloto, seguridad y arquitectura podran consolidarse en definiciones operativas suficientes para estimar y construir un piloto privado.
